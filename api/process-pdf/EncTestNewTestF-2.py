...
def process_pdf(input_pdf: str, font_path: str, output_pdf: str):
    """
    Wrapper function to maintain compatibility with the original API.
    This function takes a single font path and uses it for all font styles.
    """
    ...
    # Call the main function with default background fill
    redact_and_overwrite(input_pdf, font_paths, output_pdf, bg_fill=(1,1,1))
